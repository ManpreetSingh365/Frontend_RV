...
export default function PageHeader({ onRoleCreated }: PageHeaderProps) {
    return (
            ...
            <div className="flex items-center gap-2 sm:gap-3">
                <AddRoleDialog onRoleCreated={onRoleCreated}>
                    ...
                    >
                        ...
                        <span className="hidden min-[375px]:inline">Add New Role</span>
                        <span className="min-[375px]:hidden">Add Role</span>
                    </Button>
                </AddRoleDialog>
