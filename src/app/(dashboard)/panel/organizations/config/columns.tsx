...
/**
 * Column definition factory for Organizations table
 * Returns columns with action handlers injected
 */
export function createOrganizationColumns(handlers: {
    onEdit: (organization: Organization) => void;
    onDelete: (organization: Organization) => void;
    onRestore?: (organization: Organization) => void;
    onHardDelete?: (organization: Organization) => void;
    ...
    return [
        ...
        },
        {
            ...
            header: "Domain",
            cell: (row) => (
                <span className="text-sm text-foreground font-mono">{row.domain}</span>
            ),
            sortable: true,
        },
        {
                ...
                return (
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <span className="text-sm text-muted-foreground line-clamp-1 max-w-[300px] cursor-help">
                                {text}
                            </span>
                        </TooltipTrigger>
